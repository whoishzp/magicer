...
[![Version](https://img.shields.io/badge/version-2.4.2-blue.svg)](https://github.com/whoishzp/one/releases)
...
- **会话结束按钮**：每个活跃会话右侧新增结束图标，点击取消 pending call 并归档
- **MCP 断线恢复**：ONE 重启后自动重建待发送队列 + 连接失败自动重试规则
