...
[![Version](https://img.shields.io/badge/version-1.83.0-blue.svg)](https://github.com/whoishzp/magicer/releases)
...
- **Enter 后门**：弹窗期间 3 秒内连按 Enter N 次，强制显示关闭按钮（默认 4 次；开启「不可直接关闭」后需 10 次）
