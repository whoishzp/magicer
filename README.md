...
[![Version](https://img.shields.io/badge/version-1.61.0-blue.svg)](https://github.com/whoishzp/magicer/releases)
...
- **启动命令**：App 启动时自动执行配置的 Shell 命令（可配置多条，各自启用/禁用）；每条可在设置中一键立即执行，无需重启
